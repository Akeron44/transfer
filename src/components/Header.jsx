...
import { trailSignOutline,menuOutline, logOutOutline,  } from "ionicons/icons";
  ...
  return (
    <header className={classes.header}>
      ...
      <div className={classes.action_container}>
        ...
        <div onClick={toggleOptionsOpenedHandler} className={`${classes.action_buttons} ${classes.primary__secondary}`}>
      ...
      <Options receivedOffersNumber={receivedOffersNumber}  sentOffersNumber={pendingNegotiations.length} logOut={logOutHandler} />
